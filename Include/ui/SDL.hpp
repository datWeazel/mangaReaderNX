...
void drawImage(SDL_Texture *texture, int x, int y, double angle);                    //draw image to screen from texture
void drawImageScale(SDL_Texture *texture, int x, int y, int w, int h, double angle); //scale the image drawn to screen
